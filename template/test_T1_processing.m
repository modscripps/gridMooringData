...
%
%       1 - DONE - Load data in an organized way
%       3 - DONE - Leave room for plotting/adjusting things that
...
for i1 = 1:length(instrmntTypes)
    ...
    % Now loop over each instrument of the i1'th type:
    for i2 = 1:length(loadedData.(instrmntTypes{i1}))
        
        eval([auxInstrName ' = loadedData.(instrmntTypes{i1})(i2);']);
